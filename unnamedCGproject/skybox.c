...
void loadSkybox() {
    skyboxTex[0] = loadTexture("sky_cenario/py.png");
    
    skyboxTex[1] = loadTexture("sky_cenario/py.png");
    skyboxTex[2] = loadTexture("sky_cenario/py.png");
    skyboxTex[3] = loadTexture("sky_cenario/py.png");
    skyboxTex[4] = loadTexture("sky_cenario/py.png");
    skyboxTex[5] = loadTexture("sky_cenario/py.png");
}
